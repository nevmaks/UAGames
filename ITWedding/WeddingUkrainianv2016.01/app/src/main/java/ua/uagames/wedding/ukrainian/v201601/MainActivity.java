package ua.uagames.wedding.ukrainian.v201601;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null)
            ...
            viewer.loadUrl("https://drive.google.com/file/d/0B3qWNFQol8lIZzZMSDdVZEhjRmc/view?usp=sharing");

        bundle.putString("app_name", "Wedding: Ukrainian v2016.01.");
